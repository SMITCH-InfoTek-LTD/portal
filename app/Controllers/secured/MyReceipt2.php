 ...
 * @author osagiesammy
 */
class MyReceipt2 extends BaseController {
    ...
    public function index() {
       $this->form_validation->set_error_delimiters('<div class="errormessage">', '</div>');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('secured/myreceipt2');
            ...
            $row = $query->row_array();
            if (isset($row)) {
                $_SESSION['response2'] = $row;
                redirect('secured/Printschoolreceipt2', 'refresh');
                return TRUE;
            } else {
                return FALSE;
            }
    ...
    public function toPrint() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (isset($this->response)) {
                ...
                redirect('secured/Printschoolreceipt', 'refresh');
                return TRUE;
            } else {
                return FALSE;
            }
