 ...
 * @author osagiesammy
 */
class Printmycoursesregistered extends BaseController {
    ...
    public function pdf() {
        ...
        $pdf = $this->m_pdf->load();
        $pdf->SetHeader('Course form|Registered courses|{PAGENO}');
        $pdf->SetFooter($this->session->userdata("FacAbrev").'|'.$this->session->userdata("CourseAbrev").'|https://www.ugportal.uniabuja.edu.ng');
        ...
        $html = $this->load->view('secured/printMyCoursesRegistered', $data, TRUE);
