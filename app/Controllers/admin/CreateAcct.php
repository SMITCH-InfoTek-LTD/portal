...
class CreateAcct extends BaseController {
    ...
    public function index() {
        ...
        $this->form_validation->set_rules('jambID', 'JambID', 'trim|xss_clean|exact_length[10]|alpha_numeric|is_unique[postumeapplicants.JambID]|callback_JambID_check');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            //creating sessions
            $this->securedUpdate_m->createAcct();
    ...
    public function State_check() {
        ...
        $query = $this->db->get_where('tblDemo', array('StateOforigin' => $this->state));
        if ($query->num_rows() > 0) {
            return TRUE;
        } else {
    ...
    public function Course_check() {
        ...
        $query = $this->db->get_where('tblDemo', array('FirstChoiceCourse' => $this->course));
        if ($query->num_rows() > 0) {
            return TRUE;
        } else {
