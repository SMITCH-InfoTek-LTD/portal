...
/**
 * Description of ChangeOfAdmissionapplication
 *
 * @author osagiesammy
 */
class ChangeOfAdmissionapplication extends BaseController{
    //put your code here
    //put your code here
            ...
            if ($query->num_rows() > 0) {
                ...
                foreach ($query->result() as $row) {
                    ...
                    if ($row->status == '01') {
                        ...
                        $query = $this->db->get();
                        if ($query->num_rows() > 0) {
                            $this->Paychangeremita_m->paymentAdminChangeApplication();
