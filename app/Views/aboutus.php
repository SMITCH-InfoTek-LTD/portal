...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><li><a href="/index.php/Aboutus" class="btn btn-success btn-lg active" role="button">About US</a></li>
...
<section>
    ...
    <h1>About this page :: This is the about page</h1>
