        ...
        <div class="row content">
            ...
            <div class="col-sm-10 text-center">
                ...
                <div class="table-responsive">
                    ...
                    echo form_open('bursary/QueryFailedTransactions/getPaymentStatus', $attributes);
                    ?>
                    <div class="row">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-sm-3"><p><b>OrderID</b></p></div>
                        <div class="col-sm-2"><p><b></b></p></div>
                    </div>

                    <div class="row text-centers">
                        <?php
                        $sql = "SELECT * FROM paymentTrans WHERE status IN(021,020,023,030,031,999) ORDER BY transactiontime";
...
<div class="col-sm-3">
                                <?= $row->message ?>
                                <input align="centre" type="hidden" class="form-control" name="OrderID" value="<?= $row->OrderID ?>" size="18" required readonly/>
                            </div>
