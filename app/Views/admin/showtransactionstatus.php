        ...
        <div class="row content">
            ...
            <div class="col-sm-10 text-center">
                ...
                <div class="table-responsive">
                    ...
                    echo form_open('admin/QueryFailedTransactions/getPaymentStatus', $attributes);
                    ?>
                    <div class="row">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-sm-2"><p><b>OrderID</b></p></div>
                    ...
                    <div class="row text-centers">
                        <?php
                        $sql = "SELECT * FROM paymentTrans WHERE status != '01' ORDER BY transactiontime";
