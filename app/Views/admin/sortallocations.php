            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="table-responsive">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="" class="table table-responsive">
                        ...
                        echo form_open('admin/SortAllocations', $attributes);
                        ?>
                        <tr>
                            <td align="left"><label class="control-label">Update records</label></td>
                            <td align="left"><input class="form-control" id="sorting" name="sorting" placeholder="sorting" 
                                                    type="text" value="START....SORT HOSTEL ALLOCATION UPDATING ITEM CODE..." size="50"/></td>
