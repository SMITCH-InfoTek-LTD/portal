        ...
        <div class="row content">
            ...
            <div class="col-sm-10 text-center">
                ...
                <div class="table-responsive">
                    <?php
                    $attributes = array(
                        'id' => 'MyReceipt6', 'class' => 'form-horizontal','target'=>'_blank',
                        'role' => 'form', 'name' => 'MyReceipt6');
                    echo form_open('secured/MyReceipt6', $attributes);
                    ?>
                    <div class="row">
...
$sql = "SELECT * FROM paymentTrans WHERE ((status = '01') OR (status = '00'))"
                                ."AND((paymentTrans.Item_Code IN(1002)))"
