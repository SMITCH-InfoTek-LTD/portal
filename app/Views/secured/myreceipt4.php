...
?>
<title>Change of Institution</title>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-center">
                ...
                <legend>Change of Institution</legend>
                <div class="table-responsive">
                    <?php
                    $attributes = array(
                        'id' => 'MyReceipt4', 'class' => 'form-horizontal','target'=>'_blank',
                        'role' => 'form', 'name' => 'MyReceipt4');
                    echo form_open('secured/MyReceipt4', $attributes);
                    ?>
                    <div class="row">
...
$sql = "SELECT * FROM paymentTrans WHERE ((status = '01') OR (status = '00'))"
                                ."AND((paymentTrans.Item_Code = '3003'))"
