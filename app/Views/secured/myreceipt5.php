...
?>
<title>School Fees Shortfall</title>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-center">
                ...
                <legend>School Fees Shortfall</legend>
                <div class="table-responsive">
                    <?php
                    $attributes = array(
                        'id' => 'MyReceipt5', 'class' => 'form-horizontal','target'=>'_blank',
                        'role' => 'form', 'name' => 'MyReceipt5');
                    echo form_open('secured/MyReceipt5', $attributes);
                    ?>
                    <div class="row">
...
$sql = "SELECT * FROM paymentTrans WHERE ((status = '01') OR (status = '00'))"
                                ."AND((paymentTrans.Item_Code IN(6001,6002,6003,6004)))"
