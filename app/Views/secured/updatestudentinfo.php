...
<script type="text/javascript">
    $(document).ready(function () {
        $('#StateOfOrigin').change(function (eve) {
            ...
            //alert(post_data);
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/secured/Updatetudentinfoc/ajax_call", //The url where the server req would we made.
                async: false,
            ...
            <div class="col-sm-10 text-center">
                ...
                <div class="">
                    <strong>
                        ...
                        if (isset($message)) {
                            echo '<a href="' . base_url() . 'index.php/secured/Logoutc" class="btn btn-success role="button">'."  <font color='red'><b>" . $this->session->flashdata('message') . "</b></font>" .'   You may have to logout for your profile to reflect your new changes</a>';
                        }
                        ?>
                    </strong>
                </div>
                <div class="table-responsive">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="table table-sm table-hover table-striped table-responsive">
                        ...
                        echo form_open('secured/Updatestudentinfoc', $attributes);
                        ?>
                        <thead>
                            <tr>
                        ...
                        <tr>
                            <td align="left"><label class="control-label">RegNo</label></td>
                        ...
                        <tr>
                            <td align="left"><label class="control-label">Sex</label></td>
                        ...
                        <tr>
                            <td align="left"><label class="control-label">State Of Origin</label></td>
                            <td align="left">
                                <input class="form-control" id="StateOfOrigin" placeholder="StateOfOrigin" name="StateOfOrigin"
                                       value="<?php echo $this->session->userdata('StateOfOrigin'); ?>" size="25"  readonly/>
                            </td>
                            <td align="left"><label class="control-label">Local Govt of Origin</label>
                            </td>
                            <td>
                                <select class="form-control" id="LGA" name="LGA">
                                    ...
                                    <?php
                                    $query = $this->db->query("SELECT DISTINCT lganame FROM localgovts ORDER BY lganame");
                        ...
                        <tr>
                            <td align="left"><label class="control-label">Hometown</label></td>
                            ...
                            <td align="left"><label class="control-label">Nationality</label></td>
                            <td align="left"><input type="text" name="nation" value="<?php echo $this->session->userdata('nation'); ?>" size="25" required class="form-control" readonly>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left">
                                <input class="form-control" placeholder="dob" name="dob" id="dob" 
                                       type="text" value="<?php echo $this->session->userdata('dob'); ?>" size="25" required readonly>
                            </td>
                            <td align="left">
                                <label class="control-label">MaritalStatus</label></td>
                            <td align="left">
                                <select name="maritalstatus" required class="form-control">
                                    <option value="<?php echo $this->session->userdata('mstatus'); ?>" selected><?php echo $this->session->userdata('mstatus'); ?></option>
                        ...
                        <tr>
                            <td align="left"><label class="control-label">Admission Mode</label></td>
                            <td align="left"><select name="admode" class="form-control">
                                    <option value="<?php echo $this->session->userdata('admode'); ?>" selected><?php echo $this->session->userdata('admode'); ?></option>
                        ...
                        <tr>
                            ...
                            <td align="left"><input class="form-control" id="regnum" name="degree" placeholder="degree" 
                                                    type="text" value="<?php echo $this->session->userdata('degree'); ?>" size="25" readonly /></td>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <textarea class="form-control" name="permaddr" id="permaddr" wrap="hard"  cols="28" rows="5" required>
                                    <?php echo $this->session->userdata('residential'); ?>
                                </textarea>
                            </td>
                            <td align="left">
                                <label for="contactaddress" class="control-label">Contact Address</label></td>
                            <td align="left"><textarea class="form-control" name="contactaddr" id="contactaddr" wrap="hard" cols="28" rows="5" required>
                                <?php echo $this->session->userdata('ContactAddress'); ?>
                                </textarea></td>
                        </tr>
                        <tr>
                            <td align="left">
                            ...
                            <td align="left">
                                <input class="form-control"class="form-control" id="password" placeholder="enter your password"
                                       type="password" name="password" value="<?php echo $this->session->userdata('password'); ?>" size="25"  />
                            </td>
                            <td align="left">
                            ...
                            <td align="left"> <input class="form-control" id="cpassword" placeholder="renter your password to confirm"
                                                     type="password" name="cpassword" value="<?php echo $this->session->userdata('password'); ?>" size="25"  /></td>            
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="left"><textarea class="form-control" name="nokpermaddr" id="contactaddr" wrap="hard" cols="28" rows="5" required>
                                <?php echo $this->session->userdata('NOKAddress'); ?>
                                </textarea>
                            </td>
                            <td align="left">
                                <label class="control-label">Next of Kin Email</label></td>
                            <td align="left"><input class="form-control" id="email" placeholder="next of kin email" name="nokemail" 
                                                    id="nokemail" type="email" value="<?php echo $this->session->userdata('NOKEmail'); ?>"  size="25" required /></td>
                        </tr>
                        <tr>
                            <td align="left">
