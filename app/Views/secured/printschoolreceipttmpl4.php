...
if (isset($_SESSION["response4"])) {
    $response4 = $_SESSION["response4"];
}
?>
<body>
    <!-- main content -->
     ...
     <div  class="row pad-top-botm client-info">
         ...
         <h4>  <strong>Candidate's Information</strong></h4>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6" align="right">
               ...
               <b>Remita Retrieval Reference(RRR) : </b> <?php echo $response4['RRR']; ?>
              <br />
               <b>Payment Status :</b>  <?php echo $response4['message']; ?> 
               <br />
               <b>Amount paid :</b>  <?php echo $response4['Amount']; ?>
              <br />
               <b>Payment Date :</b> <?php echo $response4['transactiontime'] ;?>
               <br/>
               <b>Transaction ReferenceID :</b> <?php echo $response4['OrderID']; ?>
         </div>
     </div>
     <div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12">
           <div class="table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><?php echo $response4['ItemName']; ?></td>
                                    <td><?php echo $response4['Amount'] ;?></td>
                                    <td><?php echo $response4['Amount'] ;?></td>
                                </tr>                 
                            </tbody>
                        </table>
             ...
             <hr />
             <div class="ttl-amts">
               <h5>  Total Amount : <?php echo $response4['Amount'] ;?> </h5>
             </div>
             <hr />
