...
?>
<title>Change of Admission(application)</title>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-center">
                ...
                <legend>Change of Admission(application)</legend>
                <div class="table-responsive">
                    <?php
                    $attributes = array(
                        'id' => 'MyReceipt2', 'class' => 'form-horizontal', 'target' => '_blank',
                        'role' => 'form', 'name' => 'MyReceipt2');
                    echo form_open('secured/MyReceipt2', $attributes);
                    ?>
                    <div class="row">
                    ...
                    <div class="row text-centers">
                        ...
                        $sql = "SELECT * FROM paymentTrans WHERE ((status = '01') OR (status = '00'))"
                                . "AND((paymentTrans.Item_Code = '3001'))"
