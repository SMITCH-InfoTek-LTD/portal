        ...
        <div class="col-sm-8 text-center">
            ...
            <div class="table-responsive">
             <?php
                ...
                echo form_open('secured/GetPaymentStatusID', $attributes);
                ?>
                <table border="0" cellpadding="0" cellspacing="0" class="table table-sm table-responsive">
                    ...
                    <tr>
                        <td align="right"><label class="control-label">Enter Your ORDERID:</label></td>
                        <td align="left"><input type="text" class="form-control" placeholder="Enter Your ORDERID" name="OrderID" required></td>
