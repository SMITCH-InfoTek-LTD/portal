     ...
     <div  class="row pad-top-botm client-info">
         ...
         <h4>  <strong>Candidate's Information</strong></h4>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6" align="right">
               ...
               <b>Remita Retrieval Reference(RRR) : </b> <?php echo $_SESSION['RRR0']; ?>
              <br />
               <b>Payment Status :</b>  <?php echo $_SESSION['sts']; ?> 
               <br />
               <b>Amount paid :</b>  <?php echo $_SESSION['Amt']; ?>
              <br />
               <b>Payment Date :</b> <?php echo $_SESSION['tTime'] ;?>
               <br/>
               <b>Transaction ReferenceID :</b> <?php echo  $_SESSION['tID']; ?>
         </div>
     </div>
     <div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12">
           <div class="table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><?php echo $_SESSION['itName']; ?></td>
             ...
             <hr />
             <div class="ttl-amts">
               <h5>  Total Amount : <?php echo $_SESSION['Amt'] ;?> </h5>
             </div>
             <hr />
