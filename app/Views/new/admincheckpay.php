        ...
        <div class="row content">
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="table-responsive">
                    ...
                    echo form_open('new/AdminCheckPay', $attributes);
                    ?>
...
<?php echo validation_errors(); ?>
                        ...
                        <input class="form-control" id="amtO" name="smitch" value="4500" type="hidden" readonly="true"/>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" title="Payment Item" id="paymentItem" name="paymentItem" value="Admission Notification Fee" type="text" readonly="true"/>
                            </td>
                        </tr>
                        <input class="form-control" id="itemcode" name="ItemCode" value="1001" type="hidden" readonly="true"/>
                        <tr>
                            <td align="right"><label class="control-label">Amount: <font color="red">*</font></label></td>
                            <td align="left">
                                <input class="form-control" id="amt" name="Amount" value="4500" type="text" readonly="true"/>
                            </td>
                        </tr>
                        <td align="right"><label class="control-label">Payment Type:</label></td>
                        <td><input class="form-control" id="itemname" value="Admission Notification Fee" name="itemname" type="hidden" readonly="true"/>
                        ...
                        <input class="form-control" id="servicetypeid" name="servicetypeid" value="1277344390" type="hidden" readonly="true"/>
                        <tr>
                            <td></td>
                            <td colspan="">
