...
?>
<title>
    PAY NOW CHANGE OF ADMISSION FORM
</title>
<body>
        ...
        <div class="row content">
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="table-responsive">
                    ...
                    echo form_open('new/ChangeOfAdmissionapplication', $attributes);
                    ?>
...
<?php echo validation_errors(); ?>
                        ...
                        <tr>
                            <td align="right"><label class="control-label">Enter JambID:</label></td>
                        ...
                        <tr>
                            ...
                            <td align="left"><input class="form-control" name="studentype" id="studentype" value="NEW STUDENT" type="text" readonly="true"/></td>
                        <input class="form-control" id="academic_session" name="academic_session" value="<?php echo ACADEMIC_SESSION ?>" type="hidden" readonly="true"/>
                        <input class="form-control" id="amtO" name="smitch" value="5000" type="hidden" readonly="true"/>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" title="Payment Item" id="paymentItem" name="paymentItem" value="Change of Admission Application" type="text" readonly="true"/>
                            </td>
                        </tr>
                        <input class="form-control" id="itemcode" name="ItemCode" value="3001" type="hidden" readonly="true"/>
                        <tr>
                            <td align="right"><label class="control-label">Amount: <font color="red">*</font></label></td>
                            <td align="left">
                                <input class="form-control" id="amt" name="Amount" value="5000" type="text" readonly="true"/>
                            </td>
                        </tr>
                        <td align="right"><label class="control-label">Payment Type:</label></td>
                        <td><input class="form-control" id="itemname" value="Change of Admission Application" name="itemname" type="hidden" readonly="true"/>
                        ...
                        <input class="form-control" id="servicetypeid" name="servicetypeid" value="1357265124" type="hidden" readonly="true"/>
                        <tr>
                            <td></td>
                            <td colspan="">
...
<?php echo form_close(); ?>
    ...
    <script>
        function payment(str) {
            ...
            jQuery.ajax({type: "GET", data: post_data, url: "<?php echo base_url(); ?>" + "index.php/new/AdminCheckPay/paymentItem?q=" + str,
        ...
        function ShowCandName(str) {
            var post_data = {"<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"};
            jQuery.ajax({type: "GET", data: post_data, url: "<?php echo base_url(); ?>" + "index.php/new/AdminCheckPay/showCandName?q=" + str,
                dataType: "json", success: function (res) {
                    if (res) {
                        document.getElementById("payerName").value = res[0].candname;
                        document.getElementById("Course").value = res[0].Course;
                        document.getElementById("faculty").value = res[0].faculty;
                        document.getElementById("dept").value = res[0].dept;
                    }
                }});
        }
    </script>