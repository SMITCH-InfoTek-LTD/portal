        ...
        <div class="row content">
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="table-responsive">
                    ...
                    echo form_open('new/Prescreening', $attributes);
                    ?>
...
<?php echo validation_errors(); ?>
                        ...
                        <input class="form-control" id="amtO" name="smitch" value="2500" type="hidden" readonly="true"/>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" title="Payment Item" id="paymentItem" name="paymentItem" value="Prescreening Fee" type="text" readonly="true"/>
                            </td>
                        </tr>
                        <input class="form-control" id="itemcode" name="ItemCode" value="1002" type="hidden" readonly="true"/>
                        <tr>
                            <td align="right"><label class="control-label">Amount: <font color="red">*</font></label></td>
                            <td align="left">
                                <input class="form-control" id="amt" name="Amount" value="2500" type="text" readonly="true"/>
                            </td>
                        </tr>
                        <td align="right"><label class="control-label">Payment Type:</label></td>
                        <td><input class="form-control" id="itemname" value="Prescreening" name="itemname" type="hidden" readonly="true"/>
                        ...
                        <input class="form-control" id="servicetypeid" name="servicetypeid" value="1357298913" type="hidden" readonly="true"/>
                        <tr>
                            <td></td>
                            <td colspan="">
