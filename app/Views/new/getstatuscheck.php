...
if (isset($_SESSION["response"])) {
    ...
    $_SESSION['RRR'] = $response['RRR'];$_SESSION['orderId'] = $response['orderId'];$_SESSION['message'] = $response['message'];
    $_SESSION['transactiontime'] = $response['transactiontime'];$_SESSION['status'] = $response['status'];
    $_SESSION['amount'] = $response['amount'];
} else {
    redirect("new/GetPaymentStatus", "refresh");
}
?>
<body>
                    ...
                    <table class="table table-bordered table-striped">
                        <tbody>
                            <?php if ($_SESSION['status'] == '01' || $_SESSION['status'] == '00') { ?>
                                ...
                                <tr>
                                    <td align="right">
                                        <a class="btn btn-success btn-lg" href="<?php echo base_url(); ?>index.php/new/Printpayreceiptadmchk">
                                            <button type="submit" class="btn btn-success btn-sm">
                                                <img src="<?php echo base_url(); ?>assets/images/b_pdfdoc.png" width="15" height="15" />
                                            </button><b>Print receipt:</b>
                                    </td>
                                    <td align="left">
